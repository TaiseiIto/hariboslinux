...
void main(void)
{
	...
	init_memory();
	create_event_queue();
	print_serial_polling("finish create_event_queue()\n");
	init_pic();
	print_serial_polling("finish init_pic()\n");
	init_timer();
	print_serial_polling("finish init_timer()\n");
	init_keyboard();
	print_serial_polling("finish init_keyboard()\n");
	init_mouse();
	print_serial_polling("finish init_mouse()\n");
	init_screen();
	print_serial_polling("finish init_screen()\n");
