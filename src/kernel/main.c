...
void main(void)
{
	...
	fill_box(0x0000, 0x0000, 0x0010, 0x0010, 0x06, 0x00, 0x00);
	fill_box(0x0010, 0x0000, 0x0010, 0x0010, 0x00, 0x06, 0x00);
	fill_box(0x0020, 0x0000, 0x0010, 0x0010, 0x00, 0x00, 0x06);
	while(1)hlt();
}
