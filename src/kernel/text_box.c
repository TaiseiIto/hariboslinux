...
void text_box_insert_char_back(TextBox *text_box, CharacterPosition *position, char wedge)
{
	...
	insert_char_back(text_box->string, position ? position->character : NULL, wedge);
...
void text_box_insert_string_back(TextBox *text_box, CharacterPosition *position, char const *wedge)
{
	...
	// Insert the character
	insert_char_array_back(text_box->string, position ? position->character : NULL, wedge);
	// Prepare new position for the new character.
	new_position = malloc(sizeof(*new_position));
	if(position)
	{
...
void text_box_insert_string_front(TextBox *text_box, CharacterPosition *position, char const *wedge)
{
	...
	// Insert the character
	insert_char_array_front(text_box->string, position ? position->character : NULL, wedge);
	// Prepare new position for the new character.
	new_position = malloc(sizeof(*new_position));
	if(position)
	{
