...
void init_idt(void)
{
	...
	// overflow exception
	set_gate((InterruptDescriptor *)0x00000000 + 0x00000004, interrupt_handler0x04, INTERRUPT_DESCRIPTOR_INTERRUPT_GATE);
	...
	// mouse interrupt
	set_gate((InterruptDescriptor *)0x00000000 + 0x0000002c, interrupt_handler0x2c, INTERRUPT_DESCRIPTOR_INTERRUPT_GATE);
	// FPU error exception
