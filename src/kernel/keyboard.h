...
typedef struct _KeyboardEvent
{
	...
	#define ALT_KEY_PUSHED 0x0001
	#define CAPS_LOCK_ON 0x0002
	#define CONTROL_KEY_PUSHED 0x0004
	#define KEYBOARD_CONTROLLER_SEND_READY 0x0008
	#define KEY_PUSHED 0x0010
	#define KEY_RELEASED 0x0020
	#define LEFT_SHIFT_KEY_PUSHED 0x0040
	#define LEFT_SUPER_KEY_PUSHED 0x0080
	#define RIGHT_SHIFT_KEY_PUSHED 0x0100
	#define RIGHT_SUPER_KEY_PUSHED 0x0200
	#define SHIFT_KEY_PUSHED 0x0400
	#define SUPER_KEY_PUSHED 0x0800
	#define UPPER_CASE 0x1000
	...
	#define KEYBOARD_CONTROLLER_SUCCESS_ACK 0xfa
	#define KEYBOARD_CONTROLLER_FAILURE_ACK 0xfe
} KeyboardEvent;
