...
FLOPPY_FILES = diskcontents/loaddisk.bin diskcontents/getmemmp.bin diskcontents/initscrn.bin diskcontents/mv2prtmd.bin diskcontents/dplydisk.bin diskcontents/kernel.bin diskcontents/test0.txt diskcontents/test1.txt diskcontents/test2.txt diskcontents/test3.txt diskcontents/test4.txt
...
src/kernel.bin: src/kernel/boot.h src/kernel/font/bitmap.txt src/kernel/exception.c src/kernel/exception.h src/kernel/font/translator.c src/kernel/font/Makefile src/kernel/font.c src/kernel/font.h src/kernel/gdt.c src/kernel/gdt.h src/kernel/graphic.c src/kernel/graphic.h src/kernel/idt.c src/kernel/idt.h src/kernel/io.h src/kernel/io.s src/kernel/kernel.ld src/kernel/keyboard.c src/kernel/keyboard.h src/kernel/libgcc.c src/kernel/libgcc.h src/kernel/main.c src/kernel/math.c src/kernel/math.h src/kernel/memory.c src/kernel/memory.h src/kernel/mouse.c src/kernel/mouse.h src/kernel/pic.c src/kernel/pic.h src/kernel/serial.c src/kernel/serial.h src/kernel/stack.c src/kernel/stack.h src/kernel/stdio.c src/kernel/stdio.h src/kernel/stdlib.h src/kernel/string.c src/kernel/string.h src/kernel/task.c src/kernel/task.h
	make -C src
